...
class Work{
	public static array[] contact = new array[0];
	...
	public final static void clearConsole() { 
	 ...
	 public static void extendArrays(){
        array[] tempContac=new array[contact.length+1];

        for(int i=0; i<contact.length; i++) {
            tempContac[i]=contact[i];
        }
        contact=tempContac;
    }
    ...
    public static String generateId(){
		...
		String lastId=contact[contact.length-1].Id;
    ...
    public static void addContacts(){
        ...
        do{
            ...
            contact[contact.length-1]=new array(id,name,phoneNumber,companyName,birthday,salary);
    ...
    public static void updatePhoneNumber(int index){
        ...
        contact[index].Pnumber=newPhoneNumber;
    }
    //--------------------------UPDATE NAME----------------------------
    public static void updateCompanyName(int index){
        ...
        contact[index].Cname=newCompanyName;
    }
    //--------------------------UPDATE NAME----------------------------
    public static void updateSalary(int index){
        ...
        contact[index].salary=newSalary;
    }
    ...
    public static void searchContacts(){
     ...
     public static void delete(int index){
		...
		array[]tempary = new array[contact.length-1];

        for(int i=index; i<contact.length-1; i++) {
    ...
    public static void sortingByName(){
		 array[] temp = new array[contact.length];
        ...
        for(int j=1; j<contact.length; j++){
            for(int i=0; i<contact.length-j; i++){
